...
, formaloo_row_slug TEXT, tracking_code TEXT, submit_number TEXT, pdf_link TEXT, duplicate_reviewed_at TEXT);
...
, external_edit_source TEXT
  ...
  ), external_edited_at TEXT, external_edit_approved_at TEXT, external_edit_changes_json TEXT, external_edit_notification_claimed_for_at TEXT, external_edit_notification_claimed_for_version INTEGER, duplicate_reviewed_at TEXT);
...
CREATE TABLE sheets_connections (
  ...
  sync_error_started_at TEXT,
  sync_alerted_at TEXT,
  sync_alert_claimed_at TEXT,
  sync_recovery_pending_at TEXT,
...
CREATE TABLE staff_notification_delivery_logs (
...
CREATE INDEX idx_sheets_sync_jobs_connection_history
...
CREATE INDEX idx_staff_notification_delivery_logs_account
  ON staff_notification_delivery_logs (line_account_id, created_at);

CREATE INDEX idx_staff_notification_destinations_account
  ON staff_notification_destinations (line_account_id, enabled, channel_type);

CREATE UNIQUE INDEX idx_staff_notification_destinations_line_code
...
CREATE UNIQUE INDEX idx_staff_notification_destinations_line_user
