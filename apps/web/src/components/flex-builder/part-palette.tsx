...
const ITEMS: PaletteItem[] = [
  { kind: 'heading', icon: '🅰', label: '見出し', hint: '大きい太字の文字' },
  { kind: 'body', icon: '📝', label: '本文', hint: '説明の文章' },
  { kind: 'image', icon: '🖼', label: '画像', hint: '写真・バナー' },
  { kind: 'button', icon: '🔘', label: 'ボタン', hint: '押すとリンク先へ飛ぶ' },
  { kind: 'separator', icon: '➖', label: '区切り線', hint: '上下を仕切る細い線' },
  { kind: 'spacer', icon: '⬜', label: '余白', hint: 'すき間をあける' },
]
